 ...
 * @method  string          getText()         (Optional). Brief description of the game or high scores
 ...
 * @method  MessageEntity[] getTextEntities() (Optional). Special entities that appear in text, such as
 *           usernames, URLs, bot commands, etc.
 * @method  Animation       getAnimation()    (Optional). Animation that will be displayed in the game
