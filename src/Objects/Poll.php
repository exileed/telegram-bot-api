 ...
 * @method int           getCorrectOptionId() 0-based identifier of the correct answer option.
 ...
 * @method string        getExplanation() Text that is shown when a user chooses an incorrect answer
 * or taps on the lamp icon in a quiz-style poll, 0-200 characters
 * @method MessageEntity[] getExplanationEntities() (Optional) Special entities like usernames, URLs, bot commands, etc.
